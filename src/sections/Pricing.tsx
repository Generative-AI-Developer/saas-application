  ...
  return(
      ...
      <section className="py-24 bg-white">
        <div className="container">
          ...
          <p className="section-description mt-5">Free for ever. Upgrade for unlimited tasks, better security and exclusive feachers.</p>
          </div>
        <div className='flex flex-col gap-6 items-center mt-10 lg:flex-row lg:items-end lg: justify-center '>
        {
              pricingTiers.map(({title, monthlyPrice, buttonText, popular,inverse,features})=>(
                  <div className={twMerge('card', inverse === true && 'border-black bg-black text-white')}>
                    ...
                    <h3 className={twMerge('text-lg font-bold text-black/20', inverse ===true && 'text-white/60')}>{title}</h3>
                      {popular ===true && (
